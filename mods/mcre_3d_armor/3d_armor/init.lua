...
minetest.register_tool("mcre_3d_armor:helmet_leather", {
...
minetest.register_tool("mcre_3d_armor:helmet_steel", {
...
minetest.register_tool("mcre_3d_armor:helmet_gold", {
...
minetest.register_tool("mcre_3d_armor:helmet_diamond",{
...
minetest.register_tool("mcre_3d_armor:helmet_chain", {
...
minetest.register_tool("mcre_3d_armor:chestplate_leather", {
...
minetest.register_tool("mcre_3d_armor:chestplate_steel", {
...
minetest.register_tool("mcre_3d_armor:chestplate_gold", {
...
minetest.register_tool("mcre_3d_armor:chestplate_diamond",{
	description = "Diamond Helmet",
...
minetest.register_tool("mcre_3d_armor:chestplate_chain", {
...
minetest.register_tool("mcre_3d_armor:leggings_leather", {
...
minetest.register_tool("mcre_3d_armor:leggings_steel", {
...
minetest.register_tool("mcre_3d_armor:leggings_gold", {
...
minetest.register_tool("mcre_3d_armor:leggings_diamond",{
	description = "Diamond Helmet",
...
minetest.register_tool("mcre_3d_armor:leggings_chain", {
...
minetest.register_tool("mcre_3d_armor:boots_leather", {
...
minetest.register_tool("mcre_3d_armor:boots_steel", {
...
minetest.register_tool("mcre_3d_armor:boots_gold", {
...
minetest.register_tool("mcre_3d_armor:boots_diamond",{
	description = "Diamond Helmet",
...
minetest.register_tool("mcre_3d_armor:boots_chain", {
...
local craft_ingreds = {
	leather = "mcre_default:wood",
	steel = "mcre_default:steel_ingot",
	gold = "mcre_default:gold_ingot",
	diamond = "mcre_default:diamond",
	chain = "mcre_fire:fire",
}		

for k, v in pairs(craft_ingreds) do
	minetest.register_craft({
		output = "mcre_3d_armor:helmet_"..k,
		recipe = {
			{v, v, v},
			{v, "", v},
			{"", "", ""},
	...
	minetest.register_craft({
		output = "mcre_3d_armor:chestplate_"..k,
		recipe = {
			{v, "", v},
			{v, v, v},
			{v, v, v},
	...
	minetest.register_craft({
		output = "mcre_3d_armor:leggings_"..k,
		recipe = {
			{v, v, v},
			{v, "", v},
			{v, "", v},
