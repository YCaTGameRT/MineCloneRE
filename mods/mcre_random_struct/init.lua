...
--compability for MineCloneRE
core.register_alias("default:sprucetree", "mcre_default:sprucetree")
core.register_alias("default:sprucewood", "mcre_default:sprucewood")
core.register_alias("fences:fence_wood", "mcre_fences:fence_wood")
core.register_alias("flowers:pot", "mcre_flowers:pot")
core.register_alias("default:wood", "mcre_default:wood")
core.register_alias("default:tree", "mcre_default:tree")
core.register_alias("farming:soil_wet", "mcre_farming:soil_wet")
core.register_alias("default:water_source", "mcre_default:water_source")
core.register_alias("farming:wheat", "mcre_farming:wheat")
core.register_alias("farming:wheat_3", "mcre_farming:wheat_3")
core.register_alias("torches:wand", "mcre_torches:wand")
core.register_alias("wool:black", "mcre_wool:black")
core.register_alias("default:cobble", "mcre_default:cobble")
core.register_alias("xpanes:pane_glass_natural_10", "mcre_xpanes:pane_glass_natural_10")
core.register_alias("farming:wheat_2", "mcre_farming:wheat_2")
core.register_alias("default:ladder", "mcre_default:ladder")
core.register_alias("doors:door_wood_t_1", "mcre_doors:door_wood_t_1")
core.register_alias("xpanes:pane_glass_natural_5", "mcre_xpanes:pane_glass_natural_5")
core.register_alias("default:dirt", "mcre_default:dirt")
core.register_alias("default:dirt_with_grass", "mcre_default:dirt_with_grass")
core.register_alias("default:lava_source", "mcre_default:lava_source")
core.register_alias("xpanes:pane_iron_5", "mcre_xpanes:pane_iron_5")
core.register_alias("xpanes:pane_iron_4", "mcre_xpanes:pane_iron_4")
core.register_alias("mesecons_pressureplates:pressure_plate_wood_off", "mcre_mesecons_pressureplates:pressure_plate_wood_off")
core.register_alias("default:gravel", "mcre_default:gravel")
core.register_alias("inventory:crafting_table", "mcre_inventory:crafting_table")
core.register_alias("default:bookshelf", "mcre_default:bookshelf")
core.register_alias("doors:door_wood_b_1", "mcre_doors:door_wood_b_1")
core.register_alias("default:sand", "mcre_default:sand")
core.register_alias("default:sandstone", "mcre_default:sandstone")
core.register_alias("default:sandstonesmooth", "mcre_default:sandstonesmooth")
core.register_alias("hardened_clay:orange", "mcre_hardened_clay:orange")
core.register_alias("default:sandstonecarved", "mcre_default:sandstonecarved")
core.register_alias("hardened_clay:red", "mcre_hardened_clay:red")
